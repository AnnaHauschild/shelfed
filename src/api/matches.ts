...
import { ShelfType } from './shelfSync';
import { MediaType } from './types';

/**
 * Followees who have this title on the given shelf (default Favorites) — a
 * "match". Relies on the shelf_items SELECT policy that lets a follower read a
 * followee's rows.
 */
